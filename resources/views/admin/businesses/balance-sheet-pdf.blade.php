...
<body>
    <div class="container">
                ...
                <tr>
                    <td>
                        <div class="summary-box green">
                            ...
                            <div class="value">{{ number_format($monthlyIncome, 0) }} RWF</div>
                        </div>
                    </td>
                    <td>
                        <div class="summary-box red">
                            <div class="label">MONTHLY EXPENSES</div>
                            <div class="value">{{ number_format($monthlyExpenses, 0) }} RWF</div>
                        </div>
                    </td>
                    <td>
                        <div class="summary-box blue">
                            <div class="label">MONTHLY PROFIT/LOSS</div>
                            <div class="value {{ $monthlyProfit >= 0 ? 'profit' : 'loss' }}">{{ number_format($monthlyProfit, 0) }} RWF</div>
                        </div>
                    </td>
                </tr>
            </table>
        ...
        <!-- Recent Transactions -->
        <div class="section">
            <div class="section-title">Recent Transactions (Last 1000)</div>
            <table class="two-column">
                <tr>
                    <td>
                            ...
                            <tbody>
                                @forelse($recentIncomes as $income)
                                    <tr>
                                        ...
                                        <td>{{ Str::limit($income->title, 1000) }}</td>
                            ...
                            <tbody>
                                @forelse($recentExpenses as $expense)
                                    <tr>
                                        ...
                                        <td>{{ Str::limit($expense->title, 1000) }}</td>
        ...
        <div class="footer">
            ...
            <p>Generated by FinTrack By SHARP TECH LEARNERS  &copy; {{ now()->format('Y') }} | Report ID: {{ strtoupper(Str::random(8)) }}</p>
        </div>
        Powered by FinTrack Accounting Software - Your trusted partner in business finance management.
    </div>
</body>
</html>
