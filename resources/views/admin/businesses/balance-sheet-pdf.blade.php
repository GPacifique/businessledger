...
<body>
    <div class="container">
        ...
        <div class="footer">
            ...
            <p>Generated by BFTS  &copy; {{ now()->format('Y') }} | Report ID: {{ strtoupper(Str::random(8)) }}</p>
        </div>
        Powered by BFTS Accounting Software - Your trusted partner in business finance management.
    </div>
</body>
</html>
