...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="scroll-smooth">
    <head>
        ...
        <title>@yield('title', config('app.name', 'MURENZI_PROPERTIES') . ' - Property Management and Real Estate Services')</title>

        <!-- SEO Meta Tags -->
        <meta name="description" content="@yield('meta_description', 'BusinessLedger - The smart way to track your business income and expenses. Manage your finances, monitor cash flow, and make better business decisions.')">
