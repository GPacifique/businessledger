...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'BusinessLedger') }} | @yield('title', 'Welcome')</title>
                ...
                <div class="relative z-10 flex flex-col justify-between p-12 text-white w-full">
                    ...
                    <div>
                        <div class="flex items-center space-x-3 mb-4">
                            ...
                            <div>
                                <h1 class="text-3xl font-extrabold tracking-tight">BusinessLedger</h1>
                                <p class="text-indigo-200 text-sm">Business Management System</p>
                            </div>
                        </div>
                    ...
                    <!-- Features -->
                    <div class="space-y-6">
                        <h2 class="text-2xl font-bold mb-6">Why Choose BusinessLedger?</h2>
            ...
            <div class="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 bg-gray-50">
                ...
                <div class="lg:hidden mb-8 text-center">
                    <div class="flex items-center justify-center space-x-2 mb-2">
                        ...
                        <h1 class="text-2xl font-bold text-gray-800">BusinessLedger</h1>
                    </div>
