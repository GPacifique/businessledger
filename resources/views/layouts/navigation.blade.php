            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center space-x-2">
                        <div class="p-1 rounded-xl">
                            <img src="{{ asset('images/logo.png') }}" alt="FinTrack Logo" class="w-10 h-10 rounded-lg object-cover">
                        </div>
                        <span class="text-white font-bold text-lg hidden sm:block">FinTrack </span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-1 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(Auth::user()->isBusinessAdmin())
                        ...
                        <a href="{{ route('bills.index') }}" class="inline-flex items-center px-4 py-2 my-2 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('bills.*') ? 'bg-white/20 text-white shadow-inner' : 'text-white/80 hover:bg-white/10 hover:text-white' }}">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-gradient-to-b from-teal-700 to-emerald-800">
        <div class="pt-2 pb-3 space-y-1 px-4">
            ...
            @if(Auth::user()->isBusinessAdmin())
                ...
                <a href="{{ route('bills.index') }}" class="flex items-center px-4 py-3 rounded-xl text-base font-medium transition-all duration-200 {{ request()->routeIs('bills.*') ? 'bg-white/20 text-white' : 'text-white/80 hover:bg-white/10 hover:text-white' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                    </svg>
                    {{ __('messages.Bills') }}
