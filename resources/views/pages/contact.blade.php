...
<section class="py-16 lg:py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-12">
            {{-- Contact Information --}}
            <div>
                <h2 class="text-2xl font-bold text-gray-900 mb-8">{{ __('messages.Get In Touch') }}</h2>
                ...
                <div class="space-y-6 mb-10">
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-semibold text-gray-900">{{ __('messages.WhatsApp') }}</h3>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-semibold text-gray-900">{{ __('messages.Location') }}</h3>
            ...
            <div>
                <div class="bg-gray-50 rounded-2xl p-8">
                    ...
                    <form action="{{ route('contact.submit') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            <label for="phone" class="block text-sm font-medium text-gray-700 mb-2">{{ __('messages.Phone Number') }}</label>
                            <input
                                type="tel"
                                id="phone"
                                name="phone"
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="Property Inquiry">{{ __('messages.Property Inquiry') }}</option>
                                <option value="Schedule a Viewing">{{ __('messages.Schedule a Viewing') }}</option>
                                <option value="Sell My Property">{{ __('messages.Sell My Property') }}</option>
                                <option value="Investment Consultation">{{ __('messages.Investment Consultation') }}</option>
                                <option value="General Inquiry">{{ __('messages.General Inquiry') }}</option>
                                <option value="Partnership Opportunity">{{ __('messages.Partnership Opportunity') }}</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="{{ __('messages.Tell us about your property needs') }}"
                            ></textarea>
                        </div>
...
<section class="py-16 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-10">
            <h2 class="text-2xl font-bold text-gray-900 mb-4">{{ __('messages.Find Us') }}</h2>
            <p class="text-gray-600">{{ __('messages.Visit our office in') }} {{ config('landing.company.location') }}</p>
        </div>
