...
<footer class="relative z-10 bg-gradient-to-r from-emerald-900 via-teal-900 to-emerald-900">
    ...
    <div class="border-t border-white/10 py-8">
        <div class="max-w-4xl mx-auto px-6 text-center">
            ...
            <p class="text-emerald-300 text-sm">— Your dream property awaits 🏠</p>
        </div>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="md:col-span-2">
                    ...
                    <p class="text-emerald-200 text-sm leading-relaxed max-w-md">
                        Your trusted partner in real estate. Find premium properties,
                        land investments, and expert guidance for your property journey in Rwanda.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li>
                            <a href="tel:0788309762" class="flex items-center text-emerald-200 hover:text-white transition text-sm">
                        ...
                        <li>
                            <a href="https://wa.me/250788309762" target="_blank" class="flex items-center text-emerald-200 hover:text-white transition text-sm">
...
<footer class="bg-white border-t border-gray-200 mt-auto">
    ...
    <div class="bg-gradient-to-r from-emerald-50 via-teal-50 to-cyan-50 py-6">
        <div class="max-w-4xl mx-auto px-6 text-center">
            ...
            <p class="text-emerald-500 text-xs mt-2">— Your dream property awaits 🏠</p>
        </div>
    </div>
    ...
    <div class="py-6 px-6 lg:px-12">
        <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between">
            ...
            <div class="flex items-center space-x-6">
                <a href="tel:0788309762" class="text-gray-500 hover:text-emerald-600 transition flex items-center text-sm">
